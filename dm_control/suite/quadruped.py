...
class Physics(mujoco.Physics):
    ...
    def touchs(self):
        ...
        touch1 = self.named.data.sensordata['toe_front_left_sensor'][0]
        touch2 = self.named.data.sensordata['toe_front_right_sensor'][0]
        touch3 = self.named.data.sensordata['toe_back_left_sensor'][0]
        touch4 = self.named.data.sensordata['toe_back_right_sensor'][0]
        return np.array([touch1, touch2, touch3, touch4])
